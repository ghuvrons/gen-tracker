    ...
    generatePosition (report) {
      ...
      if (report) {
        if (report.frameID === this.config.frame.id.FULL) {
          pos.lng = report.data.find(el => el.field === 'gpsLongitude').value
          pos.lat = report.data.find(el => el.field === 'gpsLatitude').value
    ...
    setPath (reports) {
      ...
      if (reports.length) {
        ...
        reports.forEach(report => {
          let frameID = report.data.find(el => el.field === 'frameID').value
