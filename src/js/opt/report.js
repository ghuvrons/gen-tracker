...
const DEBUG = () => {
  ...
  return [
    ...
    {
      group: `mcu.inv`,
      field: `mcuInvDischarge`,
      title: `MCU Inv Discharge`,
      required: false,
      chartable: true,
      size: 1,
      format: (v) => HexToUnsignedInt(cend(v)),
